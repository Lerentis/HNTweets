...
def submitToot(tweetText):
    if DEBUG_MODE == False:
        ...
        mastodon.log_in(MASTADON_USER, MASTADON_PASSWORD, to_file='HNToots_usercred.txt')
        mastodon = Mastodon(client_id='HNToots_clientcred.txt', access_token='HNToots_usercred.txt')
